...
#PBS -o SubmitProj_ssp126.outlog
#PBS -e SubmitProj_ssp126.errlog
...
matlab -nodisplay -nosplash -softwareopengl -r "addpath('$ISSM_DIR/src/m/dev'); devpath; addpath('$ISSM_DIR/lib'); outputDir='$PBS_JOBFS'; numberOfWorkers=$PBS_NCPUS; proj_run_CESM_WACCM_ssp126_2015_2300($steps, $loadonly), quit" >FuncProj_ssp126.log
