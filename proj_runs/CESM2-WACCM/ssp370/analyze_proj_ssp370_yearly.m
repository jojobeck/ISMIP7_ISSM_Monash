...
% (proj_run_CESM_WACCM_ssp370_2015_2100_yearly.m).
%
...
% repeated in full here. NEW FILE -- old_scripts/proj_run_CESM_WACCM_ssp370_2015_2100.m
% is NOT modified.
%
...
%                                 original used
%                                 (postprocessed_data/CESM2-WACCM/ssp370/)
...
%                                 moved to
%                                 postprocessed_data/CESM2-WACCM/ssp370_UnconstrainedCollapse/
...
% error.
%
% Usage (run from proj_runs/CESM2-WACCM/ssp370/, ISSM already on the
...
%   analyze_proj_ssp370_yearly([1 2 3])   % all three (default)
    ...
    if perform(org, 'WriteISMIP6_NetCDF_yearly') % {{{
        ...
        % output (postprocessed_data/CESM2-WACCM/ssp370/, experiment_id
        ...
        meta.set_counter        = 'C003';     % same as the original run
