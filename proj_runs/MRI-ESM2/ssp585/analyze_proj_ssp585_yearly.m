...
% (proj_run_MRI_ESM2_ssp585_2015_2300_yearly.m).
%
% NEW FILE -- neither the original proj_run_MRI_ESM2_ssp585_2015_2300.m
...
%                                 original used
%                                 (postprocessed_data/MRI-ESM2/ssp585/)
...
%                                 moved to
%                                 postprocessed_data/MRI-ESM2/ssp585_UnconstrainedCollapse/
...
% error.
%
% Usage (run from proj_runs/MRI-ESM2/ssp585/, ISSM already on the
...
%   analyze_proj_ssp585_yearly([1 2 3])   % all three (default)
    ...
    if perform(org, 'WriteISMIP6_NetCDF_yearly') % {{{
        ...
        % output (postprocessed_data/MRI-ESM2/ssp585/, experiment_id
        ...
        outdir= [proj_root 'postprocessed_data/' CMIP_MODEL '/' SCENARIO '/'];
        ...
        meta.set_counter        = 'C008';     % same as the original run
