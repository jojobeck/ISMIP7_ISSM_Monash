...
#
# ncpus/mem here match the original submit_proj_ssp126.sh's outer-job
...
STEP=[4]
# proj_run_CESM_WACCM_ssp126_2015_2300_yearly.m signature changed: steps
...
proj_run_MRI_ESM2_ssp126_2015_2300_yearly($STEP, $start_year, $end_year, $waitonlock_seconds), quit" \
> FuncProjYearly_ssp126.log

# matlab -nodisplay -nosplash -softwareopengl -r "addpath('$ISSM_DIR/src/m/dev'); devpath; \
# addpath('$ISSM_DIR/lib'); \
# build_and_compare_levelset_v2_ssp126([3]), quit" \
# > FuncProjYearly_ssp126.log
