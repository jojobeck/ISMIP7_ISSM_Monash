function md = proj_run_MRI_ESM2_ssp126_2015_2300_yearly(steps, start_year, end_year, waitonlock_seconds)
% Standalone yearly-restart variant of proj_run_MRI_ESM2_ssp585_2015_2300.m.
%
...
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([1])                  % build TF only
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([2])                  % build SMB only
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([3])                  % build v2 levelset only
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([1 2 3])              % build all three
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([4], 2015, 2015, 3600)   % 1-yr test, 1 hr timeout
%   proj_run_MRI_ESM2_ssp585_2015_2300_yearly([4], 2015, 2300, 6*3600) % full run, 6 hr timeout/yr
%   proj_run_MRI_ESM2_ssp585_2015_2300V_yearly([4], 2100, 2300, 6*3600) % resume after a crash at 2100
%
...
%     addpath('$ISSM_DIR/lib'); proj_run_MRI_ESM2_ssp585_2015_2300_yearly([4],2015,2015,3600), quit"
    ...
    if perform(org, 'ProjRunYearly') % {{{
        ...
        load([preproc_proj_ocean 'MRI_ESM2_TF_' SCENARIO '_2015_2300.mat']);         % -> tf_proj, z_data
        load([preproc_proj_atmo  'MRI_ESM2_SMB_' SCENARIO '_2015_2300.mat']);        % -> smb_forcing, bgrad_forcing
