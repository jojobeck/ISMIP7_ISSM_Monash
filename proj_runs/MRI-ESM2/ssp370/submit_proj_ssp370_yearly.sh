...
# Submits proj_run_CESM_WACCM_ssp370_2015_2100_yearly.m -- NOT the original
# submit_proj_ssp370.sh / proj_run_CESM_WACCM_ssp370_2015_2100.m, both left
...
#
# ncpus/mem here match the original submit_proj_ssp370.sh's outer-job
# request (the OUTER MATLAB session itself loads the full 2015-2100
...
STEP=[4]
# proj_run_CESM_WACCM_ssp370_2015_2100_yearly.m signature changed: steps
...
proj_run_MRI_ESM2_ssp370_2015_2100_yearly($STEP, $start_year, $end_year, $waitonlock_seconds), quit" \
> FuncProjYearly_ssp370.log

# matlab -nodisplay -nosplash -softwareopengl -r "addpath('$ISSM_DIR/src/m/dev'); devpath; \
# addpath('$ISSM_DIR/lib'); \
# build_and_compare_levelset_v2_ssp370([3]), quit" \
# > FuncProjYearly_ssp370.log
